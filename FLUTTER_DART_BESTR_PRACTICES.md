...
- **Feature-based Organization:** For larger projects, organize code by feature,
  ...
  improves navigability and scalability with a shared core package.
...
- **Cubit:** Use cubit for state management.
...
- **Clean Architecture:** Use the clean architecture for this app.
...
- **End-to-End Tests:** Use the maestro tool for end-to-end testing. (https://maestro.dev/)
